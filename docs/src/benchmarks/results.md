...
mnem 0.1.0 vs MemPalace published numbers. Dense retrieval (vector + top-k);
...
| LoCoMo | 1986 Q (full) | R@5 session | 0.508 | **0.726** | **+0.218** | 333 (retr) |
| LoCoMo | 1986 Q (full) | R@10 session | 0.603 | **0.855** | **+0.252** | 333 (retr) |
| ConvoMem | 5 cat × 50 items (250) | avg recall | 0.929 | **0.976** | **+0.047** | 398 (retr) |
| MemBench | simple/roles, 100 items | R@5 | 0.840 | **0.960** | **+0.120** | 1874 (e2e) |
| MemBench | highlevel/movie, 100 items | R@5 | 0.950 | **1.000** | **+0.050** | 491 (e2e) |
