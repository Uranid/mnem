    ...
    pub const fn metadata(self) -> BenchMeta {
        match self {
            Self::LongMemEval => BenchMeta {
                ...
                description:
                    "500 questions, MAX-aggregate turn->session, R@5 / R@10.",
            },
            Self::Locomo => BenchMeta {
                ...
                description:
                    "10 conversations x ~200 QA, per-conv label, session R@5 / R@10.",
            },
            Self::Convomem => BenchMeta {
                ...
                description:
                    "5 headline evidence categories, substring-match avg_recall.",
            },
            Self::MembenchSimpleRoles => BenchMeta {
                ...
                description:
                    "MemBench simple/roles slice, target_step_id R@5 over 100 items.",
            },
            Self::MembenchHighlevelMovie => BenchMeta {
                ...
                description:
                    "MemBench highlevel/movie slice, target_step_id R@5 over 100 items.",
            },
            Self::LongMemEvalHybridV4 => BenchMeta {
                ...
                dataset_bytes: 264 * 1024 * 1024,
                description:
                    "LongMemEval with BM25-derived post-fusion boost; reuses LME cache.",
            },
        }
    }
}
